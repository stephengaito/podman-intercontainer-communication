...
with open('/tmp/podmanExample/serverPasta8089.log','w') as f :

  fPrint(f, "pyTools server running inside a Pasta based container")
  fPrint(f, "listening to port 8089 on all interfaces")
  fPrint(f, "")
